 ...
 */
final class Version20211215094411 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist ADD CONSTRAINT FK_1599687979B1AD6 FOREIGN KEY (company_id) REFERENCES company (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE artist ADD CONSTRAINT FK_1599687E466ACA1 FOREIGN KEY (reward_id) REFERENCES reward (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE artist ADD CONSTRAINT FK_1599687E7B003E9 FOREIGN KEY (study_id) REFERENCES study (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
